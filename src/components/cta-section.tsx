...
const GitHubIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 438.549 438.549" width="20" height="20" {...props}>
    <path
      fill="currentColor"
...
export function CTASection() {
  ...
  // Theme-aware particle color - use hex colors for better compatibility
  ...
  return (
    <section className="py-20 px-4 relative overflow-hidden min-h-[600px] flex flex-col items-center justify-center">
      {/* Simple one-line heading */}
      <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center relative z-20 mb-8 animate-appear">
      ...
      {/* Sparkles Container with Gradients - Below everything else */}
      <div className="w-[40rem] h-40 relative">
        {/* Gradient light flares */}
        ...
        {/* Core sparkles component with mask applied directly */}
        <SparklesCore
          background="transparent"
          minSize={0.4}
          maxSize={1}
          particleDensity={1200}
          className="w-full h-full [mask-image:radial-gradient(350px_200px_at_top,white_20%,transparent)]"
